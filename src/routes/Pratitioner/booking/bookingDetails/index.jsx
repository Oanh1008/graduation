                        ...
                        <div className="flex flex-wrap -mx-3 mb-2">
                            ...
                            <div className="w-full md:w-1/4 px-3">
                                ...
                                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="grid-user-name" type="text" value={data.bookInformation} />
                            </div>
                        ...
                        <div className="px-3 -mx-3 mb-2">
                            ...
                            <div className="flex flex-wrap -mx-3 mb-2">
                                ...
                                <div className="w-full md:w-1/4 px-3 mb-2 md:mb-0">
                                    ...
                                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-money" type="text" placeholder={90210} />
                                </div>
                            </div>
